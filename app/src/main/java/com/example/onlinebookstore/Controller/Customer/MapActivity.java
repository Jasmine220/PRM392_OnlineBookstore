...
public class MapActivity extends AppCompatActivity
    ...
    private static final List<PatternItem> PATTERN_POLYLINE_DOTTED = Arrays.asList(new Dot());
...
//        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(defaultLocation, 4));
